...
import random
from util_functions.utils import miller_rabin, lcm, gcd, prime_factors
...
def compute_private_exponent(e, lambda_n):
    """Computes d as the modular multiplicative inverse of e modulo λ(n)."""
    d = pow(e, -1, lambda_n)
    return d
